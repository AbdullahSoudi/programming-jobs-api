...
Note: LinkedIn search results do NOT include job descriptions.
      The description field will be empty for LinkedIn jobs.
"""
...
def _parse_search_html(html: str, search_params: dict) -> list[Job]:
    ...
    for card in cards:
        try:
            ...
            # LinkedIn search does NOT return description
            jobs.append(Job(
                title=title,
                company=company,
